...
###### FOR Auth token ####
os.system('sudo mkdir -p /home/runner/.config/sanity && sudo chmod -R 777 /home/runner/.config/sanity')
os.system('sudo cp -p ./devops/config.json /home/runner/.config/sanity/')
fin = open("/home/runner/.config/sanity/config.json", "rt")
sanitydata = fin.read()
sanitydata= sanitydata.replace('SANITY_AUTH_TOKEN', os.getenv('SANITY_AUTH_TOKEN'))
fin.close()
fin = open("/home/runner/.config/sanity/config.json", "wt")
fin.write(sanitydata)
fin.close()
