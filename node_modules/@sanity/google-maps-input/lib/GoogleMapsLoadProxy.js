...
class GoogleMapsLoadProxy extends _react.default.Component {
  ...
  render() {
    ...
    if (error) {
      return _react.default.createElement("div", null, "Load error: ", error.stack);
    }

    if (loading) {
      return _react.default.createElement("div", null, "Loading Google Maps API");
    }

    var GeopointSelect = this.props.component;
    return _react.default.createElement(GeopointSelect, _extends({}, this.props, {
      api: api
    }));
  }
